...
module Appium
  module Ios
    ...
    def texts(value = false)
      ...
      if automation_name_is_xcuitest?
        find_eles_by_predicate_include(class_name: static_text_class, value: value, only_visible: true)
      else
    ...
    def texts_exact(value)
      if automation_name_is_xcuitest?
        find_eles_by_predicate(class_name: static_text_class, value: value, only_visible: true)
      else
